...
function InmateRegister() {
  ...
  const [inmate, setInmate] = useState({
    name: "", birthDate: "", socialSecurity: "", gender: "Male",
    email: "", commitedCrime: "", arrestDate: "", sentencedYears: "",
  });
  ...
  function handleChange(e) {
    ...
    setInmate((prev) => ({ ...prev, [name]: value }));
  ...
  async function handleSubmit(e) {
    ...
    const validationErrors = validateInmate({ ...inmate, addresses });
    ...
    try {
      const res = await requestWithToast(
        createInmateWithAddress({ ...inmate, addresses }),
        "Inmate created!"
      );
  ...
  return (
    <div className="container mt-4" style={{ maxWidth: 720 }}>
      <form onSubmit={handleSubmit}>
        ...
        {/* Inmate */}
        <div className="mb-4">
          <p style={sectionLabel}>Inmate information</p>
